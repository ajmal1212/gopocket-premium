    ...
    <div className="w-full max-w-2xl mx-auto p-6 space-y-8 my-8 font-sans">
      <Card className="border-purple-200 dark:border-purple-900 shadow-lg">
        <CardHeader>
          ...
          <CardTitle className="text-2xl mt-3 font-bold text-gray-900">shadcn/ui + Radix Primitives in Astro</CardTitle>
          <CardDescription>
            ...
            <TabsContent value="accordion" className="pt-4">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    Yes. Radix UI primitives adhere to WAI-ARIA design patterns, supporting keyboard navigation and
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    Simply create new files under <code>src/components/ui/</code> or install additional Radix UI
                    packages as needed.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This modal is powered by <code>@radix-ui/react-dialog</code> inside an Astro page with{" "}
